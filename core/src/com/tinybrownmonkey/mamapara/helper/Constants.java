...
public class Constants {
    ...
    public final static int[] lanePositions = new int[] {210, 130, 50};
    public final static int jeepLoc = 50;
    public final static float groundSpeedIncrement = 1;
    public final static float angleSpeed = 100;
    public final static float grabberRange = 200;
    public final static float grabberSpeed = 100;
